The MyRetailApp is a quick prototype created using create-react-app npm package. Data in the webpage is based on the mock data available in the item-data.json file present in root folder 'db/'.

The following table of contents has instructions on variety of topics including
- [Running unit test](#npm-test),
- [Continuous Integration](#continuous-integration),
- [Steps required for deploying the application](#deployment).
